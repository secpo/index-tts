...
def main():
    ...
    parser.add_argument("--model_dir", type=str, default="checkpoints", help="Path to the absolute model checkpoints directory.")
    parser.add_argument("--config", type=str, default="checkpoints/config.yaml", help="Path to the absolute model's config.yaml file.")
